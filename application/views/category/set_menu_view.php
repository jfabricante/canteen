		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="box box-danger menu-items">
					...
					<div class="box-body">
						<ul class="list-group">
							<draggable class="dragArea" :list="menu" :options="{group:'product'}" @change="log" style="min-height: 200px;">
								<li v-for="(item, index) in menu" :key="index" class="col-md-2 list-group-item">
